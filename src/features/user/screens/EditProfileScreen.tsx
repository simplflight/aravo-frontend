...
const styles = StyleSheet.create({
  ...
  globalErrorText: { color: Colors.error, fontSize: 14, fontWeight: 'bold', textAlign: 'center', marginBottom: 16, padding: 12, backgroundColor: Colors.errorLight, borderRadius: 8 },
});
